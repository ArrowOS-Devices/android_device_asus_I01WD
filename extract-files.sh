...
patchelf --remove-needed android.hidl.base@1.0.so \
        "${ARROW_ROOT}/vendor/${VENDOR}/${DEVICE}/proprietary/lib/libfm-hci.so"
patchelf --remove-needed android.hidl.base@1.0.so \
        "${ARROW_ROOT}/vendor/${VENDOR}/${DEVICE}/proprietary/lib64/libfm-hci.so"

sed -i 's/<library name="android.hidl.manager-V1.0-java"/<library name="android.hidl.manager@1.0-java"/g' \
        "${ARROW_ROOT}/vendor/${VENDOR}/${DEVICE}/proprietary/etc/permissions/qti_libpermissions.xml"
